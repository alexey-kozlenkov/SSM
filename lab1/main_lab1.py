...
plot_histogram(mcg_result, 20, 'lab1/mcg', title='Multiplicative congruential generator')
...
plot_histogram(mmg_result, 20, 'lab1/maclaren-marsaglia', title='MacLaren-Marsaglia generator')
